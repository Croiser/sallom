...
export class IntelligenceService {
   ...
   */
  static async getChurnRisk(ownerUid: string) {
   ...
   */
  static async getCashFlowProjection(ownerUid: string) {
   ...
   */
  static async getUpsellSuggestions(ownerUid: string, clientId: string) {
   ...
   */
  static async handleIncomingMessage(uid: string, from: string, text: string) {
    try {
      ...
      if (!settings || !settings.aiEnabled || !settings.enabled) return;
